...
window.ROUTES = {
  ...
  "hkt-blue-elephant": { "base": "phuket", "hotel": "merlin", "km": 18.3, "min": 26, "on": "2026-09-22",
    "key": "7.88349,98.27245>7.88607,98.38459",
    "poly": "gxbo@czxvQaBaOzIgIcMkNbCgAvLjCRgDqNsJdM{QyIoAyHgIgHsWeKgJgk@mWq`AwFlFwYrFkJQaIxGsXmG{LdBsAoAyDtEur@cEeGoIqAuB{FtHG}@aJqd@ap@hSoO|VpBpIkHFqNfJ_IdFkP_Es\\~D_RcFqHbGuTsHcP\\_G`dAul@p]anAoDqYmFe@G`B" },
  ...
  "hkt-suay": { "base": "phuket", "hotel": "merlin", "km": 23.6, "min": 31, "on": "2026-09-22",
    "key": "7.88349,98.27245>7.98009,98.32942",
    "poly": "gxbo@czxvQaBaOzIgIcMkNbCgAvLjCRgDqNsJxLoSmI[yHgI}DwRkLwMkm@yXsZaDse@{AaLtB}k@b\\{HbLbFb]sKzTgHhAiGxHwIlAl@hJyB~CoYlK}g@cI_OiHqTzCq_@eEsLiLaJoXePwN}Th@cFbOan@qE{AlQaNdIiCkCiJLgGvSyPmJ}AoEkJHuFiJ`CkZsKsGeGwRcC}a@cY_RiCeIsWuAaAmExH{iAzMy\\rf@_d@f@aV}EL" },
  "hkt-wagyu": { "base": "phuket", "hotel": "merlin", "km": 17, "min": 23, "on": "2026-09-22",
    "key": "7.88349,98.27245>7.97668,98.28189",
    "poly": "gxbo@czxvQaBaOzIgIcMkNbCgAvLjCRgDqNsJxLoSmI[yHgI}DwRkLwMkm@yXsZaDse@{AaLtB}k@b\\{HbLbFb]sKzTgHhAiGxHwIlAl@hJyB~CoYlK}g@cI_OiHqTzCq_@eEsLiLaJoXePwN}Th@cFbOan@qE{AlQaNdIiCkCiJLgGvSyPmJ_A}DmJDgEuF" },
